export const grpPieChartAdvertiserPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A783%7D&dashboard_id=52`,
  payload: {
    "datasource": {
      "id": 226,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "filterOptionName": "filter_evldncrooi_o1gps3tjbi",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
