export const spendVNDBarChartAdvertiserPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A563%7D&dashboard_id=49`,
  payload: {
    "datasource": {
      "id": 195,
      "type": "table"
