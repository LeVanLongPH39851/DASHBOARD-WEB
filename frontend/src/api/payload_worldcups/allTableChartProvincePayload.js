export const allTableChartProvincePayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A920%7D&dashboard_id=66`,
  payload: {
    "datasource": {
      "id": 276,
      "type": "table"
    ...
    "form_data": {
      ...
      "adhoc_filters": [
        ...
        },
        {
          ...
          "filterOptionName": "filter_ej3b6oncbvg_7nwv7kmeybu",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
        ...
        },
        {
          ...
          "datasourceWarning": false,
          "expressionType": "SIMPLE",
          "filterOptionName": "filter_w29t9zb0scl_0ibhd2ktk3r6",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
