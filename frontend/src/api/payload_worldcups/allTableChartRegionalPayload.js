export const allTableChartRegionalPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A919%7D&dashboard_id=66`,
  payload: {
    "datasource": {
      "id": 276,
      "type": "table"
