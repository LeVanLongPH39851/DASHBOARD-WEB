export const aveReachNumberChartPayload = {
    url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A907%7D&dashboard_id=66`,
    payload: {
        "datasource": {
            "id": 276,
            "type": "table"
            ...
            "adhoc_filters": [
                {
                    ...
                    "filterOptionName": "filter_ctbjqp1gkcg_tdgwx41a2op",
                    "isExtra": true,
                    "isNew": false,
