export const aveReachPercentNumberChartPayload = {
    url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A909%7D&dashboard_id=66`,
    payload: {
        "datasource": {
            "id": 276,
            "type": "table"
            ...
            "adhoc_filters": [
                {
                    ...
                    "filterOptionName": "filter_4pwz4evstfw_wdlsco9vp7p",
                    "isExtra": true,
                    "isNew": false,
