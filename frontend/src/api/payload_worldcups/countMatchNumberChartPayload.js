export const countMatchNumberChartPayload = {
    url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A913%7D&dashboard_id=66`,
    payload: {
        "datasource": {
            "id": 276,
            "type": "table"
                ...
                "metrics": [
                    {
                        ...
                        "label": "Count (DISTINCT program_name, description)",
                        "optionName": "metric_i95y84bdsp_zg5sz26q79",
                        "sqlExpression": "Count (DISTINCT program_name, description)"
                    }
                ],
                "annotation_layers": [],
                "series_limit": 0,
            ...
            "adhoc_filters": [
                {
                    ...
                    "filterOptionName": "filter_8d5ohiy9x5h_fgosbr1b4cp",
                    "isExtra": false,
                    "isNew": false,
                    "operator": "NOT IN",
                    "operatorId": "NOT_IN",
                ...
                },
                {
                    ...
                    "datasourceWarning": false,
                    "expressionType": "SIMPLE",
                    "filterOptionName": "filter_pzacti6m2hr_m2cswztj92m",
                    "isExtra": true,
                    "isNew": false,
