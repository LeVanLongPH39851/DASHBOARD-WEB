export const durationNumberChartPayload = {
    url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A914%7D&dashboard_id=66`,
    payload: {
        "datasource": {
            "id": 276,
            "type": "table"
            ...
            "adhoc_filters": [
                {
                    ...
                    "filterOptionName": "filter_vhey7gqodc_z1mqg2koda",
                    "isExtra": true,
                    "isNew": false,
