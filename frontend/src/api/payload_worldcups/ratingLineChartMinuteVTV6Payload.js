export const ratingLineChartMinuteVTV6Payload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A922%7D&dashboard_id=66`,
  payload: {
    "datasource": {
      "id": 214,
      "type": "table"
    ...
    "queries": [
      {
        ...
        "extras": {
          "having": "",
          "where": "(channel_name_tvd = 'VTV6')"
        },
        "applied_time_extras": {},
        "columns": [
          {
            "columnType": "BASE_AXIS",
            "sqlExpression": "event_hour_minute",
            "label": "event_hour_minute",
            "expressionType": "SQL"
          },
          "date",
          "program_wc"
    ...
    "form_data": {
      "datasource": "214__table",
      "viz_type": "echarts_timeseries_smooth",
      "slice_id": 922,
      "url_params": {
        "native_filters_key": "BTinBldyeeH2Bi1Ojx6_HGLfupLGLjt7YMX4epnhJtgpGz7c1XE6Umw-cYFAv4PS"
      },
      "x_axis": "event_hour_minute",
      ...
      "adhoc_filters": [
        {
          ...
          "expressionType": "SQL",
          "filterOptionName": "filter_kvrzonu4jtg_25slkq0164a",
          "isExtra": false,
          "isNew": false,
          "operator": null,
          "sqlExpression": "channel_name_tvd = 'VTV6'",
          "subject": null
        },
        {
          "clause": "WHERE",
          ...
          "filterOptionName": "filter_7yhx4a0fpxh_8nysy32vjee",
          "isExtra": true,
          "isNew": false,
