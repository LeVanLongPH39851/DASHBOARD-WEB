export const ratingPercentNumberChartPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A910%7D&dashboard_id=66`,
  payload: {
    "datasource": {
      "id": 276,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "filterOptionName": "filter_f87dnucn9wc_9niojzhptgq",
          "isExtra": true,
          "isNew": false,
