export const ratingReachBarChartDatePayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A912%7D&dashboard_id=66`,
  payload: {
    "datasource": {
      "id": 276,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "expressionType": "SQL",
          "filterOptionName": "filter_93ijxv6u2dn_gg87exkhfxv",
          "isExtra": false,
          "isNew": false,
          "operator": null,
