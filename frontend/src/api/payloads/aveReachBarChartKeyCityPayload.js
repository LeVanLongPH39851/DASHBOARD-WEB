export const aveReachBarChartKeyCityPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A651%7D&dashboard_id=50`,
  payload: {
    "datasource": {
      "id": 210,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "filterOptionName": "filter_qxuvbmm07l8_o9w5fl3cuqs",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
        ...
        },
        {
          ...
          "datasourceWarning": false,
          "expressionType": "SIMPLE",
          "filterOptionName": "filter_pcqvwtn2bo_citq3f1q7p",
          "isExtra": true,
          "isNew": false,
