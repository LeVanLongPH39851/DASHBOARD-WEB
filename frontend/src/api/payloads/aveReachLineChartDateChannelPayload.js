export const aveReachLineChartDateChannelPayload = {
  url: 'https://ratings.vtv.vn/api/v1/chart/data?form_data=%7B%22slice_id%22%3A474%7D&dashboard_id=45',
  payload: {
    "datasource": {
      "id": 148,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "filterOptionName": "filter_du91w13aja4_pk3vkizlljk",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
        ...
        },
        {
          ...
          "datasourceWarning": false,
          "expressionType": "SIMPLE",
          "filterOptionName": "filter_7ippf6aw3v6_g9s0oxlbr5",
          "isExtra": true,
          "isNew": false,
