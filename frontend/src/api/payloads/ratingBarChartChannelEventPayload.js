export const ratingBarChartChannelEventPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A628%7D&dashboard_id=50`,
  payload: {
    "datasource": {
      "id": 210,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "filterOptionName": "filter_oww11bahazm_zet6nyv2nq",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
        ...
        },
        {
          ...
          "datasourceWarning": false,
          "expressionType": "SIMPLE",
          "filterOptionName": "filter_r6rm73h3mo_nehc75wanwe",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
        ...
        },
        {
          ...
          "datasourceWarning": false,
          "expressionType": "SIMPLE",
          "filterOptionName": "filter_utmo9qk0q1_6bsx1nw4o1m",
          "isExtra": true,
          "isNew": false,
