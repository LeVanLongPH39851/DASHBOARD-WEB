export const ratingLineChartDateChannelPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A635%7D&dashboard_id=50`,
  payload: {
    "datasource": {
      "id": 210,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "filterOptionName": "filter_jdrtg0utyx_xl5f1ia2zqo",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
        ...
        },
        {
          ...
          "datasourceWarning": false,
          "expressionType": "SIMPLE",
          "filterOptionName": "filter_9gotduij08i_udqkhegyy9d",
          "isExtra": true,
          "isNew": false,
