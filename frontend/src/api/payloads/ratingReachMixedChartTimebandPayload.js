export const ratingReachMixedChartTimebandPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A674%7D&dashboard_id=50`,
  payload: {
    "datasource": {
      "id": 210,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "filterOptionName": "filter_ssx4xspa9r_8nqd5ysfpou",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
        ...
        },
        {
          ...
          "datasourceWarning": false,
          "expressionType": "SIMPLE",
          "filterOptionName": "filter_gx4aloh30pq_fr1hpunpe1h",
          "isExtra": true,
          "isNew": false,
