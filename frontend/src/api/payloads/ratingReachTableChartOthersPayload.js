export const ratingReachTableChartOthersPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A672%7D&dashboard_id=50`,
  payload: {
    "datasource": {
        "id": 209,
        "type": "table"
    ...
    "form_data": {
        ...
        "adhoc_filters": [
            ...
            },
            {
                ...
                "datasourceWarning": false,
                "expressionType": "SIMPLE",
                "filterOptionName": "filter_l9q1pqshdyc_t4cpmfvp5t",
                "isExtra": false,
                "isNew": false,
                "operator": "NOT IN",
                "operatorId": "NOT_IN",
