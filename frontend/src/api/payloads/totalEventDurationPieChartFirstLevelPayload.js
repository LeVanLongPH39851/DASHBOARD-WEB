export const totalEventDurationPieChartFirstLevelPayload = {
  url: `${import.meta.env.VITE_API_DOMAIN}/api/v1/chart/data?form_data=%7B%22slice_id%22%3A623%7D&dashboard_id=50`,
  payload: {
    "datasource": {
      "id": 209,
      "type": "table"
      ...
      "adhoc_filters": [
        {
          ...
          "filterOptionName": "filter_8g4grzn6eze_n5m29d53yli",
          "isExtra": false,
          "isNew": false,
          "operator": "NOT IN",
          "operatorId": "NOT_IN",
        ...
        },
        {
          ...
          "datasourceWarning": false,
          "expressionType": "SIMPLE",
          "filterOptionName": "filter_qyg3393nhbl_wtkkmcqm539",
          "isExtra": true,
          "isNew": false,
