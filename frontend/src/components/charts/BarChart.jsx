...
const BarChart = ({
  ...
  const option = {
    tooltip: {
      ...
      borderWidth: 1,
      textStyle: {
        fontSize: safeFontSize.tooltip,
        color: "#1f2937",
        fontWeight: safeFontWeight.tooltip,
    ...
    legend: {
      ...
      itemHeight: 14,
      textStyle: {
        fontSize: safeFontSize.legend,
        color: "#64748b",
        fontWeight: safeFontWeight.legend,
      },
    },
    ...
    xAxis: isHorizontal
      ? {
          ...
          axisLabel: {
            ...
            fontSize: safeFontSize.axisLabel,
            color: "#6b7280",
            fontWeight: safeFontWeight.axisLabel,
          },
        }
      : {
          type: "category",
    ...
    series: sortedSeries.map((s, idx) => ({
      ...
      label: {
        ...
        fontSize: safeFontSize.dataLabel,
        fontWeight: safeFontWeight.dataLabel,
        fontFamily: safeFontFamily,
        color: "#1e293b",
        // backgroundColor: 'rgba(255,255,255,0.95)',
