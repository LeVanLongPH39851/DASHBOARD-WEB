...
export default function ChildTabs({ tabs, defaultTab, variant = 'default' }) {
  ...
  const variants = {
    default: {
      container: 'relative flex gap-1 mb-6 max-lg:mb-5 max-md:mb-4 overflow-hidden rounded-2xl p-1 bg-background-black-4 dark:bg-background-white-8 w-fit transition-all duration-500',
