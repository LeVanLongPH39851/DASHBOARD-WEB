  ...
  return (
    <span className='ml-2 text-xs text-color-icon-infor group relative'>
      <div className='border border-color-icon-infor rounded-full w-5 h-5 flex justify-center items-center hover:border-2 transition-transform cursor-pointer'>
        ...
        <div className="bottom-[50%] invisible group-hover:visible opacity-0 group-hover:opacity-100 max-w-96 bg-color-dark absolute p-4 rounded-xl shadow-2xl before:content-[''] before:absolute before:w-3
          ...
          <p className='text-white w-full whitespace-nowrap'>{description}</p>
        </div>
      </div>
    </span>
  );
