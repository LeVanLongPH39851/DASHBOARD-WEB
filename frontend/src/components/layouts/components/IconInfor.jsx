  ...
  return (
    <span className='text-xs max-md:text-[10px] text-color-black-50 group relative cursor-pointer'>
      <div className='flex justify-center'>
        ...
        <div className="bottom-[50%] font-medium invisible group-hover:visible opacity-0 group-hover:opacity-100 w-73 bg-color-black-100 dark:bg-background-dark absolute px-4 py-3 rounded-md shadow-tooltip before:content-[''] before:absolute before:w-3
