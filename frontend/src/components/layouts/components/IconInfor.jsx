  ...
  return (
    <span className='text-xs max-lg:text-[11px] max-md:text-[10px] text-color-black-50 group relative cursor-pointer'>
      <div className='flex justify-center'>
        ...
        <div className="bottom-[50%] font-normal invisible group-hover:visible opacity-0 group-hover:opacity-100 w-73 max-lg:w-70 max-md:w-58 bg-color-black-100 dark:bg-background-dark absolute px-4 py-3 max-lg:px-3 max-lg:py-2.5 max-md:px-2.5 max-md:py-2 rounded-md before:content-[''] before:absolute before:w-3
