...
const IconInfor = ({ description }) => {
  return (
    <span className='text-xs text-color-black-50 group relative cursor-pointer'>
      <div className='flex justify-center'>
        <FontAwesomeIcon icon={faCircleInfo} />
        <div className="bottom-[50%] font-medium invisible group-hover:visible opacity-0 group-hover:opacity-100 max-w-96 bg-color-black-100 absolute px-4 py-3 rounded-md shadow-tooltip before:content-[''] before:absolute before:w-3
