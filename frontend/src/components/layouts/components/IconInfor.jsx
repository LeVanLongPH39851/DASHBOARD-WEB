  ...
  return (
    <span className='text-xs max-md:text-[10px] text-color-black-50 group relative cursor-pointer'>
      <div className='flex justify-center'>
        ...
        <div className="bottom-[50%] font-normal invisible group-hover:visible opacity-0 group-hover:opacity-100 w-73 bg-color-black-100 dark:bg-background-dark absolute px-4 py-3 rounded-md shadow-tooltip before:content-[''] before:absolute before:w-3
                        ...
                        before:rotate-45 group-hover:bottom-[115%] transition-all duration-300 z-9999">
          <p className='text-color-white-90 w-full text-wrap'>{description}</p>
        </div>
      </div>
    </span>
  );
