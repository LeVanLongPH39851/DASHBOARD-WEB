...
const InforTab = ({ inforTab, maxInsert=false }) => {
  ...
  return (
    <section id='inforTabSticky' className={`px-6 max-lg:px-5 max-md:px-4 py-3 flex gap-2.5 max-lg:gap-2 h-12 max-lg:h-11 max-md:h-10 items-center sticky top-29.25 max-lg:top-[93.56px] max-md:top-12.25 bg-background-dashboard dark:bg-background-dashboard-dark transition-all duration-300 border-b ${!stateGlobals.isInfor ? ' border-border-black-10 dark:border-background-white-15' : 'border-transparent'}`} style={{zIndex: 200}}>
