...
export const useRatingBarChartChannelEventReturnApi = () =>
  createChartHook(
    getChart.getRatingBarChartChannelEvent,
    "barChannelEventData",
  )();

export const useAveReachBarChartChannelEventReturnApi = () =>
  createChartHook(
    getChart.getAveReachBarChartChannelEvent,
    "barChannelEventData",
  )();
...
export const useRatingBarChartProvinceReturnApi = () =>
  createChartHook(
    getChart.getRatingBarChartProvince,
...
export const useRatingLineChartMinuteChannelReturnApi = () =>
  createChartHook(
    getChart.getRatingLineChartMinuteChannel,
    "ratingLineMinuteChannelData",
  )();

export const useRatingLineChartMinuteChannelOneDateReturnApi = () =>
  createChartHook(
    getChart.getRatingLineChartMinuteChannelOneDate,
