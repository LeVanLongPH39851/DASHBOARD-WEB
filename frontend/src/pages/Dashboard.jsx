            ...
            <ParentTabs uniqueId='dashboard'
              ...
              tabs={[
                ...
                ((!userLoading && user?.username !== 'vtvguest') ? {
                  id: 'rating_by_minute', label: !stateGlobals.screen_md ? 'Rating theo phút' : 'Rating phút', icon: !stateGlobals.darkMode ? iconRatingByMinute : iconRatingByMinuteDark, iconActive: iconRatingByMinuteActive,
                  content: (
