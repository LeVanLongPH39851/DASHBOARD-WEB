  ...
  return (
    <main className="font-family-be-vietnam-pro w-full h-full tracking-[0.1px] overflow-x-clip">
      ...
      <div className="flex w-full h-full bg-background-light dark:bg-background-dark transition-all duration-300">
        ...
        >
          <BreadCrumb
            dashboardName="FIFA WORLD CUP 2026"
            icon={!darkMode ? iconWorldCup : iconWorldCupDark}
            widthIcon="w-12 max-lg:w-8 max-md:w-7.25"
          />
              ...
              tabs={[
                {
                  ...
                  icon: !darkMode ? iconBall : iconBallDark,
                  iconActive: iconBallActive,
                  content: (
                    <section
                    ...
                    >
                      ...
                      <InforFilter
                        ...
                        FilterComponent={FilterWorldCup}
                      ...
                      <div className="px-6 max-lg:px-5 max-md:px-4 pt-6 max-lg:pt-5 max-md:pt-4">
                        <div className="w-full grid grid-cols-3 max-lg:grid-cols-3 max-md:grid-cols-2 gap-6 max-lg:gap-5 max-md:gap-4 pb-6 max-lg:pb-5 max-md:pb-4">
                          <NumberCard
                            ...
                            value={useMemo(
                              () =>
                                !dashboard.isLoading.countMatchNumberData
                                  ? dashboard.countMatchNumberData?.data
                                    ? formatNumber(
                                        dashboard.countMatchNumberData?.data[0][
                                          "Count (DISTINCT program_name, description)"
                                        ],
                                        { isPercent: false },
                                      )
                                    : "-"
                            ...
                            refetch={useCallback(
                              () => dashboard.refetch("countMatchNumberData"),
                              [dashboard.isLoading.countMatchNumberData],
                            )}
                          />
                          <NumberCard
                            ...
                            refetch={useCallback(
                              () => dashboard.refetch("ratingNumberData"),
                              [dashboard.isLoading.ratingNumberData],
                            )}
                          />
                          <NumberCard
                            ...
                            refetch={useCallback(
                              () => dashboard.refetch("aveReachNumberData"),
                              [dashboard.isLoading.aveReachNumberData],
                            )}
                          />
                          <NumberCard
                              ...
                              () =>
                                !dashboard.isLoading.durationNumberData
                                  ? dashboard.durationNumberData?.data
                                    ? dashboard.durationNumberData?.data[0]?.minute_user_program?.toLocaleString(
                                        undefined,
                          ...
                          <NumberCard
                              ...
                              () =>
                                !dashboard.isLoading.ratingPercentNumberData
                                  ? dashboard.ratingPercentNumberData?.data
                                    ? formatNumber(
                                        dashboard.ratingPercentNumberData
                                          ?.data[0]["rating%"],
                                        { isPercent: true },
                                      )
                                    : "-"
                            ...
                            refetch={useCallback(
                              () =>
                                dashboard.refetch("ratingPercentNumberData"),
                              [dashboard.isLoading.ratingPercentNumberData],
                            )}
                          />
                          <NumberCard
                              ...
                              () =>
                                !dashboard.isLoading.aveReachPercentNumberData
                                  ? dashboard.aveReachPercentNumberData?.data
                                    ? formatNumber(
                                        dashboard.aveReachPercentNumberData
                                          ?.data[0]["reach%"],
                                        { isPercent: true },
                                      )
                                    : "-"
                            ...
                            refetch={useCallback(
                              () =>
                                dashboard.refetch("aveReachPercentNumberData"),
                              [dashboard.isLoading.aveReachPercentNumberData],
                            )}
                          />
                        </div>
                        <div className="w-full pb-6 max-lg:pb-5 max-md:pb-4">
                          <MixedChart
                            data={useMemo(
                              () =>
                                !dashboard.isLoading.ratingReachBarDateData
                                  ? transformMixedChartData(
                                      dashboard.ratingReachBarDateData?.data,
                                      "date",
                                      dashboard.ratingReachBarDateData
                                        ?.colnames,
                                    )
                                  : "isLoading",
                              [dashboard.isLoading.ratingReachBarDateData],
                            ...
                            nameChart={
                              "Biến động khán giả World Cup 2026 theo ngày (THTT)"
                            }
                            maxVisibleItems={
                            ...
                            refetch={useCallback(
                              () => dashboard.refetch("ratingReachBarDateData"),
                              [dashboard.isLoading.ratingReachBarDateData],
                            )}
                          />
                        </div>
                        <div className="w-full pb-6 max-lg:pb-5 max-md:pb-4 grid grid-cols-2 max-md:grid-cols-1 gap-6 max-lg:gap-5 max-md:gap-4">
                          <BarChart
                            data={useMemo(
                              () =>
                                !dashboard.isLoading.ratingPercentBarChannelData
                                  ? transformBarChartData(
                                      dashboard.ratingPercentBarChannelData
                                        ?.data,
                                      dashboard.ratingPercentBarChannelData
                                        ?.colnames,
                                    )
                            ...
                            nameChart={
                              "Rating (%) chương trình World Cup trên các kênh"
                            }
                            description={false}
                                  ...
                                  content: (
                                    <TableChart
                                      data={useMemo(
                                        () =>
                                          !dashboard.isLoading
                                            .allTableRegionalData
                                            ? transformTableChartData(
                                                dashboard.allTableRegionalData
                                                  ?.data,
                                                dashboard.allTableRegionalData
                                                  ?.colnames,
                                              )
                                      ...
                                      nameChart={
                                        "Khán giả World Cup theo thị trường"
                                      }
                                      description={false}
                                      showSTT={false}
                                  ...
                                  content: (
                                    <TableChart
                                      data={useMemo(
                                        () =>
                                          !dashboard.isLoading
                                            .allTableProvinceData
                                            ? transformTableChartData(
                                                dashboard.allTableProvinceData
                                                  ?.data,
                                                dashboard.allTableProvinceData
                                                  ?.colnames,
                                              )
                        ...
                        <div className="w-full pb-6 max-lg:pb-5 max-md:pb-4">
                          <TableChart
                            data={useMemo(() => {
                              !dashboard.isLoading.allTableTeamData
                                ? transformTableChartData(
                                    dashboard.allTableTeamData?.data,
                                    dashboard.allTableTeamData?.colnames,
                                  )
                                : "isLoading";
                            }, [dashboard.isLoading.allTableTeamData])}
                            height={"425px"}
                            ...
                            showPagination={true}
                            refetch={useCallback(
                              () => dashboard.refetch("allTableTeamData"),
                              [dashboard.isLoading.allTableTeamData],
                            )}
                          />
                        </div>
                        <div className="w-full pb-6 max-lg:pb-5 max-md:pb-4">
                          <TableChart
                            data={useMemo(
                              () =>
                                !dashboard.isLoading.allTableShareData
                                  ? transformTableChartData(
                                      dashboard.allTableShareData?.data,
                                      dashboard.allTableShareData?.colnames,
                                    )
                                  : "isLoading",
                              [dashboard.isLoading.allTableShareData],
                            )}
                            ...
                            showPagination={true}
                            refetch={useCallback(
                              () => dashboard.refetch("allTableShareData"),
                              [dashboard.isLoading.allTableShareData],
                            )}
                          />
                        </div>
                            ...
                            data={useMemo(
                              () =>
                                !dashboard.isLoading.ratingLineMinuteVTV6Data
                                  ? transformMixedChartData(
                                      dashboard.ratingLineMinuteVTV6Data?.data,
                                      "event_hour_minute",
                                      dashboard.ratingLineMinuteVTV6Data
                                        ?.colnames,
                                    )
                                  : "isLoading",
                              [dashboard.isLoading.ratingLineMinuteVTV6Data],
